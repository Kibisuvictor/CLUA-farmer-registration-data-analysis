...
levels(Tree_species$type)<-c("Mangifera indica (mango)","Cocos nucifera (coconut)","Grevillea robusta (silver oak)","Other","Annona reticulata (Custard apple)","Psidium guajava (Guava)","Tamarindus indica (Tamarind)","Artocarpus heterophyllus (Jackfruit)","Azadirachta indica (Neem)","Carica papaya (Papaya)","Citrus Limon (Lemon)")
